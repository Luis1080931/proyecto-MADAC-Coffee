...
const ResetPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put("http://localhost:3000/cambiar", {
                token,
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md z-10">
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex justify-center">
                        <Button
                            type="submit"
                            className="text-[#FDFBF6] bg-[#273468] h-10 px-8 rounded-lg font-bold flex justify-center items-center border-[#FDFBF6]"
                        >
