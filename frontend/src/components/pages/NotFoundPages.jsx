...
import ImgNotFound from './../../assets/icons/notFoundPages.png';
  ...
  return (
    <section className="bg-blancoMedio1 flex h-screen items-center justify-center">
      <div className="flex flex-col md:flex-row justify-center items-center gap-5 md:gap-20">
        <img src={ImgNotFound} alt="Error 404" className="h-2/4 w-2/4"/>
        <div className="text-center md:text-left">
          ...
          <Link to="/dashboard" className="bg-grisMedio3 hover:bg-grisOscuro text-blanco font-semibold text-base py-3 px-6 rounded-lg transition duration-200 border">
            Volver al Inicio
          </Link> 
        </div>
      </div>
