...
export default function Ejemplo({ clickEditar, clickDesactivar,clickActivar, clickRegistrar, data, variables }) {
      ...
      case "actions":
        return (
          <div className="relative flex justify-end items-center gap-2">
            <ButtonActualizar click={() => handleUpdateClick(variable.v_codigo)} />
            {variable.estado === 'activo' ? (
              <ButtonDesactivar click={() => clickDesactivar(variable.v_codigo)} />
            ) : (
              <ButtonActivar click={() => clickActivar(variable.v_codigo)} />
            )}
          </div>
        );
      default:
