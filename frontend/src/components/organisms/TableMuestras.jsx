...
export default function Ejemplo({ clickEditar, clickDesactivar,clickActivar, clickRegistrar, data, muestras }) {
      ...
      case "actions":
        return (
          <div className="relative flex justify-end items-center gap-2">
            <ButtonActualizar click={() => handleUpdateClick(muestra.codigo)} />
            {muestra.estado === 'activo' ? (
              <ButtonDesactivar click={() => clickDesactivar(muestra.codigo)} />
            ) : (
              <ButtonActivar click={() => clickActivar(muestra.codigo)} />
            )}
          </div>
        );
      default:
    ...
    return (
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-xl">Total {muestras.length} Resultados</span>
...
>
  ...
  <TableBody emptyContent={"No hay muestras registradas"} items={sortedItems}>
    {(item) => (
