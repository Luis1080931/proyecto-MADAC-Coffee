...
export const listarVariables = async (req, res) => {
    try {
        let sql = 'SELECT v_codigo, v.nombre, v.fk_tipo_analisis AS tipo_analisis, ta.tipo_analisis, estado  from variables AS v JOIN tipo_analisis AS ta ON v.fk_tipo_analisis = ta.id'
